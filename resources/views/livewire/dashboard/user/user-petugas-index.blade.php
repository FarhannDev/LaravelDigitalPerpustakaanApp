            ...
            <div class="card rounded-0 shadow-0 mb-3">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-end py-3">
                        <a aria-label="Tambah Data Buku" href="{{ route('dashboard.user.operator.add') }}"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <button "
                                                wire:click=" deleteOperator({{ $user->id }})" type="button"
                                                title="hapus"
                                                class="btn btn-danger btn-md"><i
                                                    class="fas fa-fw fa-trash"></i></button>
                                            <a href="{{ route('dashboard.user.operator.edit', $user->uuid) }}"
